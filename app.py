...
# Patch class definition into __main__ for torch.load compatibility
...
# =====================================================================
app = FastAPI(
    title="DINOv2 Brain Tumor Classifier API",
...
def home():
    return {
        "status": "online",
        "message": "DINOv2 Brain Tumor API is running. Go to /docs to test prediction endpoint."
    }
...
async def predict_mri(file: UploadFile = File(...)):
    try:
        ...
        # Preprocess MRI scan to match DINOv2 input format
...
if __name__ == "__main__":
    # Binds dynamically to Render's assigned port in cloud, or defaults to 8000 locally
